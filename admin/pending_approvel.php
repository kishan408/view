<div class="container">
    <div class="row">
        <legend>Pending Approvel</legend>
        <div class="table-responsive">
            <table class="table table-condensed table-striped">
                ...
                <tr>
                    ...
                    <td><?=$dt->suspend?></td>
                    <td><?=$dt->paid?></td>
                    <td><button type="button" class="btn btn-success" id="btn" onclick="approvel(<?=$dt->id?>)">Approve</button>
    ...
    function approvel(str)
        {
          ...
          jQuery.ajax({
             type:"POST",
             url:"<?=base_url()?>"+"index.php/ajax/approvel",
             data:{id:str},
             dataType:"html",
